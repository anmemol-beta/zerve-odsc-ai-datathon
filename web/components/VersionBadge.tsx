  ...
  return (
    <div className="fixed bottom-3 right-3 z-50 pointer-events-auto group">
      <a
        ...
        className="font-mono text-[10px] tracking-wider text-slate-500 hover:text-pink-300 transition-colors px-2 py-1 rounded-md bg-ink-900/70 backdrop-blur-md border border-slate-800/60"
      >
