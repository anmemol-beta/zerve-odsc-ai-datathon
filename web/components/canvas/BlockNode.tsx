...
export default function BlockNode({ data }: { data: BlockNodeData }) {
  ...
  return (
    <div
      ...
      className="group relative w-[300px] cursor-pointer rounded-xl border bg-slate-950/80 px-4 py-3 text-left text-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.5)] backdrop-blur-md transition-all duration-200 hover:scale-[1.02] hover:shadow-[0_12px_40px_rgba(99,102,241,0.25)]"
      style={{
